    ...
    return (
        <div className='min-h-screen grow flex flex-nowrap flex-col overflow-hidden justify-center items-center relative bg-black snap-center'>
            <div className="w-full h-full flex flex-col justify-center items-center gap-0 ">
                ...
                <ShowOnScroll offset={-100} mode='fadeOut' className='duration-500 w-full text-black bg-white mix-blend-screen z-20 flex'>
                    <SizedText
                ...
                <ShowOnScroll offset={-100} mode='fadeOut' className='duration-500 grow w-full z-20 flex relative bg-gradient-to-b from-white to-transparent'>
                    <div className="btn w-fit mx-auto mt-20 fadein delayed-2500">
                        <Link href='/#quote'>
                            <a className='noselect font-IBM-Plex-Mono font-bold  text-white text-xl'>View more about me<span className='cursor' >_</span></a>
                        </Link>
                    </div>
                </ShowOnScroll>
